...
class NilaiSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Nilai
        fields = ['id', 'student', 'student_name', 'student_email', 'instructor', 
                  'instructor_name', 'course_name', 'grade', 'semester', 'created_at', 'updated_at']
        read_only_fields = ['instructor', 'created_at', 'updated_at']

class StudentListSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'email', 'username', 'full_name', 'major']